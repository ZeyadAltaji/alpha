          ...
          for (var bu in bus)
            Column(
              children: [
                ...
                baseColor: darkTheme ? Color(0xffdb5a5a) : Color(0xffEBEDEF),
                expandedColor: darkTheme ? Colors.black54 : Colors.white,
                leading: CircleAvatar(
                  foregroundColor: darkTheme ? Colors.white : Colors.grey,
                  backgroundColor: darkTheme ? Color(0xffdb5a5a) : Color(0xffEBEDEF),
                  child: Text(
    ...
    child: Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Text(arEn(data['vac_Desc'], data['vac_EngDesc'])),
            ],
          ),
          Row(
...
Future<List?> getAbsences(DateTime fDate, DateTime tDate) async {
  if (absenceData != null) return absenceData;
